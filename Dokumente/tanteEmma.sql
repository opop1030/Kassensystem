...
-- Exportiere Daten aus Tabelle tekassensystem.angestellte: ~0 rows (ungefähr)
...
INSERT INTO `artikel` (`artikelnr`, `name`, `fi_kategorie`, `bestand`, `preis`) VALUES
	('0000000000010', '1,5 l Saskia Quellwasser', 'Getraenk', 998, 0.19),
	('0123456789131', 'Mildes Weizenmischbrot', 'Nahrung', 100, 1.50),
	('0221510739120', '500g Packung Onkel Bens', 'Nahrung', 49, 3.50),
	('1001320013442', 'Gouda Jung 500g', 'Nahrung', 698, 1.30),
	('1212121212121', 'Taschenrechner', 'Elektronik', 5, 29.99),
	('1911199212121', 'Putzschwamm 6er Pack', 'Haushaltsware', 300, 4.99),
	('5000112546415', '1,25 l Coca Cola', 'Getraenk', 499, 1.79),
...
-- Exportiere Daten aus Tabelle tekassensystem.art_kategorie: ~4 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle tekassensystem.bestellung: ~7 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle tekassensystem.kunde: ~1 rows (ungefähr)
DELETE FROM `kunde`;
...
-- Exportiere Daten aus Tabelle tekassensystem.person: ~2 rows (ungefähr)
DELETE FROM `person`;
